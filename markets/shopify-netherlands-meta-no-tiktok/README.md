# Shopify brands in the Netherlands running Meta ads but not TikTok

A public list of Dutch Shopify brands that appear active on Meta but do not show a TikTok setup.

- Dataset page: [Open the latest dataset](https://www.enrichanything.com/datasets/markets/shopify-netherlands-meta-no-tiktok?utm_source=github&utm_medium=public_repo&utm_campaign=enrichanything-shopify-channel-gaps&utm_content=market-shopify-netherlands-meta-no-tiktok-dataset)
- Immutable snapshot: [Open the stable permalink](https://www.enrichanything.com/snapshots/markets/shopify-netherlands-meta-no-tiktok/2026-04-06-5da4031be9?utm_source=github&utm_medium=public_repo&utm_campaign=enrichanything-shopify-channel-gaps&utm_content=market-shopify-netherlands-meta-no-tiktok-snapshot)
...
- the Netherlands storefront or company footprint
- Shopify detected
...
The useful pattern here is not just that dutch Shopify brands exist. It is that these brands already show signs of paid-social maturity through Meta while still lacking a visible TikTok setup. That makes the list commercially useful for a next-channel pitch rather than a generic ecommerce directory.
...
```text
Build a broad, source-backed collection from Meta Ad Library advertisers and public storefront checks to find Shopify brands in the Netherlands that are actively running Meta ads but do not show a TikTok pixel. Return company name, website, location, paid-social signal, opportunity gap, and why-now notes. Prefer complete collection over a narrow ranked subset.
```

## How we built it

This list combines Shopify detection, a the Netherlands footprint, visible Meta activity, and the absence of visible TikTok setup markers. It is designed to show a credible commercial slice, not to claim full market coverage.
